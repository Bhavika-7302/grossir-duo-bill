...
const SalesScreen = () => {
  const [products] = useState<Product[]>([
    { id: '1', name: 'Milk', price: 3.50, stock: 25, category: 'Dairy' },
    { id: '2', name: 'Bread', price: 2.50, stock: 15, category: 'Bakery' },
    { id: '3', name: 'Eggs', price: 12.00, stock: 8, category: 'Dairy' },
    { id: '4', name: 'Rice', price: 15.00, stock: 0, category: 'Grains' },
    { id: '5', name: 'Chicken', price: 25.00, stock: 12, category: 'Meat' },
    { id: '6', name: 'Vegetables', price: 8.50, stock: 20, category: 'Fresh' },
    { id: '7', name: 'Fruits', price: 8.25, stock: 18, category: 'Fresh' },
    { id: '8', name: 'Salt', price: 4.25, stock: 5, category: 'Condiments' }
  ]);
  ...
  const handleAddToCart = (product: Product, quantity: number = 1) => {
    ...
    // Demo price mismatch check (10% chance)
    if (Math.random() < 0.1) {
    ...
    <div className="container mx-auto p-6">
      ...
      {showPriceMismatchModal && mismatchItem && (
        <PriceMismatchModal
          ...
          onContinue={() => {
            handleAddToCart(mismatchItem.product);
            setShowPriceMismatchModal(false);
            setMismatchItem(null);
          }}
        />
